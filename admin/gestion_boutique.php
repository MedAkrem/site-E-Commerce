...
{	// debug($_POST);
	...
	executeRequete("REPLACE INTO produit (id_produit, reference, categorie, titre, description, couleur, public, photo, prix, stock) values ('$_POST[id_produit]', '$_POST[reference]', '$_POST[categorie]', '$_POST[titre]', '$_POST[description]', '$_POST[couleur]','$_POST[public]',  '$photo_bdd',  '$_POST[prix]',  '$_POST[stock]')");
	$contenu .= '<div class="validation">Le produit en promotion enregistrer</div>';
	$_GET['action'] = 'affichage';
}
//--- LIENS PRODUITS ---//
$contenu .= '<a href="?action=affichage">Affichage des promotions</a><br />';
$contenu .= '<a href="?action=ajout">Ajout d\'une promotion</a><br /><br /><hr /><br />';
//--- AFFICHAGE PRODUITS ---//
if(isset($_GET['action']) && $_GET['action'] == "affichage")
{
	$resultat = executeRequete("SELECT * FROM produit");
	
	$contenu .= '<h2> Affichage des produits en promotion </h2>';
	$contenu .= 'Nombre de produit(s) en promotion dans la boutique : ' . $resultat->num_rows;
...
echo '
	<h1> Formulaire Produits en promotion </h1>
